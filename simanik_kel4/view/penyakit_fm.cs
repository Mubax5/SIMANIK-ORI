...
namespace simanik_kel4.view
{
    ...
    public class penyakit_fm : Form
    {
        Disease_serv Penyakit = new Disease_serv();
        ...
        private void InitializeComponent()
        {
            ...
            judul_lbl.Text = "Master Data Penyakit";
            ...
            this.Load += penyakit_fm_Load;
        }

        private void penyakit_fm_Load(object sender, EventArgs e)
        {
            tampilGrid();
        }
        ...
        void tampilGrid()
        {
            if (cari_txt.Text.Length == 0) data_dgv.DataSource = Penyakit.viewAll();
            else data_dgv.DataSource = Penyakit.searchByNama(cari_txt.Text);
        }
