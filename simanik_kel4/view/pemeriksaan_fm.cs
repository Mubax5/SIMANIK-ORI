...
namespace simanik_kel4.view
{
    ...
    public class pemeriksaan_fm : Form
    {
        Examination_serv Pemeriksaan = new Examination_serv();
        ...
        {
            this.Text = "Pemeriksaan";
            this.StartPosition = FormStartPosition.CenterScreen;
            this.ClientSize = new Size(930, 570);
            this.BackColor = background;

            Label judul_lbl = new Label();
            judul_lbl.Text = "Pemeriksaan Pasien";
            ...
            Button resep_btn = new Button();
            resep_btn.Text = "Obat";
            resep_btn.BackColor = secondary;
            resep_btn.ForeColor = Color.White;
            resep_btn.FlatStyle = FlatStyle.Flat;
            resep_btn.Location = new Point(700, 82);
            resep_btn.Size = new Size(75, 34);
            resep_btn.Click += resep_btn_Click;
            ...
            this.Controls.Add(resep_btn);
            this.Controls.Add(keluar_btn);
            this.Controls.Add(data_dgv);
            this.Load += pemeriksaan_fm_Load;
        }

        private void pemeriksaan_fm_Load(object sender, EventArgs e)
        {
            tampilGrid();
        }
        ...
        void tampilGrid()
        {
            if (cari_txt.Text.Length == 0) data_dgv.DataSource = Pemeriksaan.viewAll();
            else data_dgv.DataSource = Pemeriksaan.searchByNama(cari_txt.Text);
        }

        private void resep_btn_Click(object sender, EventArgs e)
        {
            new obat_fm().ShowDialog();
        }
