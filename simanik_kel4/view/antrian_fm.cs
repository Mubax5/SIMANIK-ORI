...
namespace simanik_kel4.view
{
    ...
    public class antrian_fm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            judul_lbl.Text = "Kunjungan dan Antrian";
            ...
            Button selesai_btn = new Button();
            selesai_btn.Text = "Selesai";
            selesai_btn.BackColor = secondary;
            selesai_btn.ForeColor = Color.White;
            selesai_btn.FlatStyle = FlatStyle.Flat;
            selesai_btn.Location = new Point(700, 82);
            selesai_btn.Size = new Size(75, 34);
            selesai_btn.Click += selesai_btn_Click;
            ...
            this.Controls.Add(selesai_btn);
            this.Controls.Add(keluar_btn);
            this.Controls.Add(data_dgv);
            this.Load += antrian_fm_Load;
        }

        private void antrian_fm_Load(object sender, EventArgs e)
        {
            tampilGrid();
        }
        ...
        void tampilGrid()
        {
            if (cari_txt.Text.Length == 0) data_dgv.DataSource = Visit.viewAll();
            else data_dgv.DataSource = Visit.searchByNama(cari_txt.Text);
        }
        ...
        private void selesai_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                string kode = data_dgv.CurrentRow.Cells["id_kunjungan"].Value.ToString();
                Visit.updateStatus(kode, "Selesai");
                tampilGrid();
            }
        }
