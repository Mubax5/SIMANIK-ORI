...
namespace simanik_kel4.view
{
    ...
    public class jadwal_dokter_fm : Form
    {
        Schedule_serv Jadwal = new Schedule_serv();
        ...
        private void InitializeComponent()
        {
            ...
            judul_lbl.Text = "Manajemen Jadwal Dokter";
            ...
            this.Load += jadwal_dokter_fm_Load;
        }

        private void jadwal_dokter_fm_Load(object sender, EventArgs e)
        {
            tampilGrid();
        }
        ...
        void tampilGrid()
        {
            if (cari_txt.Text.Length == 0) data_dgv.DataSource = Jadwal.viewAll();
            else data_dgv.DataSource = Jadwal.searchByNama(cari_txt.Text);
        }
