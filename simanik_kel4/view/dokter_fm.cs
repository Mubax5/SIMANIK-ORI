...
namespace simanik_kel4.view
{
    ...
    public class dokter_fm : Form
    {
        Doctor_serv Dokter = new Doctor_serv();
        ...
        private void InitializeComponent()
        {
            ...
            judul_lbl.Text = "Manajemen Data Dokter";
            ...
            this.Load += dokter_fm_Load;
        }

        private void dokter_fm_Load(object sender, EventArgs e)
        {
            tampilGrid();
        }
        ...
        void tampilGrid()
        {
            if (cari_txt.Text.Length == 0) data_dgv.DataSource = Dokter.viewAll();
            else data_dgv.DataSource = Dokter.searchByNama(cari_txt.Text);
        }
