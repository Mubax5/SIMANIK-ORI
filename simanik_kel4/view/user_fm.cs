...
namespace simanik_kel4.view
{
    ...
    public class user_fm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            judul_lbl.Text = "Manajemen Akun User";
            ...
            this.Load += user_fm_Load;
        }

        private void user_fm_Load(object sender, EventArgs e)
        {
            tampilGrid();
        }
        ...
        void tampilGrid()
        {
            ...
            {
                data_dgv.DataSource = User.viewAll();
            }
            else
            {
                data_dgv.DataSource = User.searchByNama(cari_txt.Text);
            }
        }
