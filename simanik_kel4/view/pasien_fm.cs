...
namespace simanik_kel4.view
{
    ...
    public class pasien_fm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            judul_lbl.Text = "Manajemen Data Pasien";
            ...
            this.Load += pasien_fm_Load;
        }

        private void pasien_fm_Load(object sender, EventArgs e)
        {
            tampilGrid();
        }
        ...
        void tampilGrid()
        {
            if (cari_txt.Text.Length == 0) data_dgv.DataSource = Pasien.viewAll();
            else data_dgv.DataSource = Pasien.searchByNama(cari_txt.Text);
        }
